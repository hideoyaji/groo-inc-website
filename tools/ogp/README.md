...
`img/ogp-v3.png` (1200x630) の生成元です。URL を Slack・LINE・Facebook などに貼ったときにカードに出る画像です。
...
"/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" --headless=new --disable-gpu \
  ...
  --screenshot="$PWD/img/ogp-v4.png" "file://$PWD/tools/ogp/ogp.html"
```

## 差し替えるとき

1. 画像は新しい名前 (`ogp-v4.png` など) で出します。同じ名前で上書きすると、SNS 側が古い画像を持ち続けます
